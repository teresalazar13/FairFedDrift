...
# from federated.algorithms.fair_fed_drift.fair_fed_drift import update_clients_identities, get_init_model, test_models
...
#             test_models(global_models, clients_data[timestep], clients_metrics, dataset, self.metrics_clustering, seed)
...
#                 results = self.test_client_on_model(self.metrics_clustering, global_model.model, client_data, dataset.is_binary_target)
...
#             results_model = self.test_client_on_model(self.metrics_clustering, model, client_data, dataset.is_binary_target)
#
#             # Detect Drift
...
#         return global_models
#
#     def test_client_on_model(self, metrics, model, client_data, is_binary_target):
#         results = []
#         pred = model.predict(client_data.x)
#         y_true, y_pred = super().get_y(client_data.y, pred, is_binary_target)
